                ...
                {!isLast && (
                  <div
                    className={cn(
                      ...
                      i < currentStepIndex ? 'bg-emerald-500' : 'bg-gray-100 dark:bg-gray-800'
                    )}
                  />
                )}
              </div>
          ...
          <div className="bg-white dark:bg-gray-950 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm p-5">
            ...
            <div className="flex flex-wrap gap-2">
              {EVENT.assignedStaff.map((name: string) => (
                <span
                  key={name}
                  className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gray-50 dark:bg-gray-900 text-sm font-semibold text-gray-700 dark:text-gray-300"
                >
            ...
            <div className="px-5 pt-5 pb-3">
              ...
              <div className="flex items-center gap-4 mt-2">
                <span className="text-xs text-gray-400 dark:text-gray-500">
                  <span className="font-semibold text-gray-600 dark:text-gray-400 tabular-nums">{confirmedCount}</span> confirmed
                </span>
                <span className="text-xs text-gray-400 dark:text-gray-500">
                  <span className="font-semibold text-gray-600 dark:text-gray-400 tabular-nums">{checkedInCount}</span> checked in
                </span>
                <span className="text-xs text-gray-400 dark:text-gray-500">
                  <span className="font-semibold text-gray-600 dark:text-gray-400 tabular-nums">{GUESTS.length}</span> total
                </span>
              </div>
            </div>
