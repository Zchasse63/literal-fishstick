                ...
                <div>
                  ...
                  <div className="rounded-xl border border-gray-200 p-3.5 space-y-2.5">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-semibold text-gray-900">{member.membership}</span>
                      <span className="text-sm font-bold text-gray-900 tabular-nums">${member.membershipPrice}/mo</span>
                    </div>
                    <div className="space-y-1.5">
                      <div className="flex items-center justify-between text-xs">
                        <span className="text-gray-500">Next Billing</span>
                        <span className="text-gray-700 font-medium">{member.nextBilling}</span>
                      </div>
                      <div className="flex items-center justify-between text-xs">
                        <span className="text-gray-500">Payment Method</span>
                        <span className="text-gray-700 font-medium">{member.paymentMethod}</span>
                      </div>
                    </div>
