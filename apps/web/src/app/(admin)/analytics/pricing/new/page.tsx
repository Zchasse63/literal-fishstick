    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      <div className="max-w-[800px] mx-auto px-6 py-8">
        ...
        <motion.div {...fadeInUp} transition={{ ...fadeInUp.transition, delay: 0.05 }} className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-900">New Simulation</h1>
            <p className="text-sm text-gray-500 mt-0.5">Model a pricing scenario and project revenue impact</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm space-y-4">
            <h2 className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Simulation Details</h2>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Price Changes</h2>
              {availablePlans.length > 0 && (
                <div className="relative group">
                  ...
                  <div className="absolute right-0 top-full mt-1 w-56 bg-white border border-gray-200 rounded-xl shadow-lg z-10 hidden group-hover:block">
                    {availablePlans.map((plan) => (
                      ...
                      >
                        ...
                        <span className="text-gray-400 ml-2">${plan.price}/mo</span>
                      </button>
                    ))}
                  </div>
                </div>
            ...
            {loadingPlans ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-500">No price changes added yet.</p>
                  ...
                  return (
                    ...
                    >
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-gray-900">{change.plan_name}</p>
                      ...
                      <div className="flex items-center gap-3">
                        <div className="relative w-28">
                          ...
                          <input
                            ...
                            className="w-full rounded-lg border border-gray-200 pl-7 pr-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-300 transition-colors"
                          />
                        </div>
