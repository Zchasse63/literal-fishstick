      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <motion.div {...fadeInUp} className="mb-6 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => window.alert('CSV export coming in Phase 3')} className="inline-flex items-center gap-1.5 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 px-3 py-2 text-xs font-semibold text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-800 transition"><Download className="h-3.5 w-3.5" />CSV</button>
            <button onClick={() => window.alert('PDF export coming in Phase 3')} className="inline-flex items-center gap-1.5 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 px-3 py-2 text-xs font-semibold text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-800 transition"><FileDown className="h-3.5 w-3.5" />PDF</button>
            ...
            <button onClick={() => window.alert('Report editing coming in Phase 3')} className="inline-flex items-center gap-1.5 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 px-3 py-2 text-xs font-semibold text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-800 transition"><Pencil className="h-3.5 w-3.5" />Edit</button>
          </div>
        </motion.div>
