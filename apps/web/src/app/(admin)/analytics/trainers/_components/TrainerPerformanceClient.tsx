...
// --- Props ---
interface TrainerPerformanceClientProps {
  initialTrainers: Trainer[]
}

export function TrainerPerformanceClient({ initialTrainers }: TrainerPerformanceClientProps) {
  ...
  const [COACH_NOTES] = useState<string[]>([])
