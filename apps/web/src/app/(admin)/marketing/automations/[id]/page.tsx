...
// ─── Mock automations by ID ────────────────────────────────
const AUTOMATION_DB: Record<string, { meta: AutomationMeta; nodes: Node<NodeData>[]; edges: Edge[] }> = {
  '1': {
    meta: { name: 'Welcome Sequence', triggerType: 'signup', active: true, enrolled: 312, completed: 287, conversionRate: 72 },
    nodes: [
      { id: 'trigger-1', type: 'triggerNode', position: { x: 300, y: 40 }, data: { stepType: 'trigger', label: 'New Signup', triggerType: 'signup' } },
      { id: 'email-1', type: 'emailNode', position: { x: 300, y: 180 }, data: { stepType: 'email', label: 'Welcome Email', subject: 'Welcome to The Sauna Guys!', body: 'Hi {{first_name}}, welcome! Here is what to expect...' } },
      { id: 'wait-1', type: 'waitNode', position: { x: 300, y: 320 }, data: { stepType: 'wait', label: 'Wait 2 days', duration: 2, durationUnit: 'days' } },
      { id: 'email-2', type: 'emailNode', position: { x: 300, y: 460 }, data: { stepType: 'email', label: 'First Class Tips', subject: 'Tips for your first sauna session', body: 'Hi {{first_name}}, ready for your first session? Here are some tips...' } },
      { id: 'wait-2', type: 'waitNode', position: { x: 300, y: 600 }, data: { stepType: 'wait', label: 'Wait 3 days', duration: 3, durationUnit: 'days' } },
      { id: 'condition-1', type: 'conditionNode', position: { x: 300, y: 740 }, data: { stepType: 'condition', label: 'Booked a class?', conditionField: 'days_since_last_visit', conditionOp: 'less_than', conditionValue: '5' } },
      { id: 'tag-1', type: 'tagNode', position: { x: 100, y: 920 }, data: { stepType: 'tag', label: 'Tag: onboarded', tagName: 'onboarded', tagAction: 'add' } },
      { id: 'email-3', type: 'emailNode', position: { x: 500, y: 920 }, data: { stepType: 'email', label: 'Nudge Email', subject: 'We saved you a spot!', body: 'Hi {{first_name}}, you have not booked yet. How about {{next_class}}?' } },
    ],
    edges: [
      { id: 'e1', source: 'trigger-1', target: 'email-1', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e2', source: 'email-1', target: 'wait-1', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e3', source: 'wait-1', target: 'email-2', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e4', source: 'email-2', target: 'wait-2', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e5', source: 'wait-2', target: 'condition-1', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e6', source: 'condition-1', sourceHandle: 'yes', target: 'tag-1', animated: true, style: { stroke: '#10b981', strokeWidth: 2 }, label: 'Yes', labelStyle: { fontWeight: 700, fontSize: 11, fill: '#10b981' }, markerEnd: { type: MarkerType.ArrowClosed, color: '#10b981' } },
      { id: 'e7', source: 'condition-1', sourceHandle: 'no', target: 'email-3', animated: true, style: { stroke: '#f97316', strokeWidth: 2 }, label: 'No', labelStyle: { fontWeight: 700, fontSize: 11, fill: '#f97316' }, markerEnd: { type: MarkerType.ArrowClosed, color: '#f97316' } },
    ],
  },
  '2': {
    meta: { name: 'Win-Back: 14-Day Inactive', triggerType: 'inactivity', active: true, enrolled: 47, completed: 31, conversionRate: 17 },
    nodes: [
      { id: 'trigger-1', type: 'triggerNode', position: { x: 300, y: 40 }, data: { stepType: 'trigger', label: 'No booking in 14 days', triggerType: 'inactivity' } },
      { id: 'wait-1', type: 'waitNode', position: { x: 300, y: 180 }, data: { stepType: 'wait', label: 'Wait 2 days', duration: 2, durationUnit: 'days' } },
      { id: 'email-1', type: 'emailNode', position: { x: 300, y: 320 }, data: { stepType: 'email', label: 'We miss you!', subject: 'We miss you at The Sauna Guys!', body: 'Hi {{first_name}}, it has been a while! Your favorite spot in the sauna is waiting...' } },
      { id: 'condition-1', type: 'conditionNode', position: { x: 300, y: 480 }, data: { stepType: 'condition', label: 'Opened email?', conditionField: 'email_opened', conditionOp: 'equals', conditionValue: 'true' } },
      { id: 'tag-1', type: 'tagNode', position: { x: 100, y: 660 }, data: { stepType: 'tag', label: 'Tag: win-back-engaged', tagName: 'win-back-engaged', tagAction: 'add' } },
      { id: 'sms-1', type: 'smsNode', position: { x: 500, y: 660 }, data: { stepType: 'sms', label: 'SMS reminder', body: 'Hey {{first_name}}! We miss you. Book your next sauna session today and get 10% off.' } },
    ],
    edges: [
      { id: 'e1', source: 'trigger-1', target: 'wait-1', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e2', source: 'wait-1', target: 'email-1', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e3', source: 'email-1', target: 'condition-1', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e4', source: 'condition-1', sourceHandle: 'yes', target: 'tag-1', animated: true, style: { stroke: '#10b981', strokeWidth: 2 }, label: 'Yes', labelStyle: { fontWeight: 700, fontSize: 11, fill: '#10b981' }, markerEnd: { type: MarkerType.ArrowClosed, color: '#10b981' } },
      { id: 'e5', source: 'condition-1', sourceHandle: 'no', target: 'sms-1', animated: true, style: { stroke: '#f97316', strokeWidth: 2 }, label: 'No', labelStyle: { fontWeight: 700, fontSize: 11, fill: '#f97316' }, markerEnd: { type: MarkerType.ArrowClosed, color: '#f97316' } },
    ],
  },
  '3': {
    meta: { name: 'Failed Payment Recovery', triggerType: 'failed_payment', active: true, enrolled: 12, completed: 9, conversionRate: 42 },
    nodes: [
      { id: 'trigger-1', type: 'triggerNode', position: { x: 300, y: 40 }, data: { stepType: 'trigger', label: 'Failed Payment', triggerType: 'failed_payment' } },
      { id: 'email-1', type: 'emailNode', position: { x: 300, y: 180 }, data: { stepType: 'email', label: 'Payment failed', subject: 'Action needed: Payment failed', body: 'Hi {{first_name}}, we could not process your payment. Please update your card to keep your membership active.' } },
      { id: 'wait-1', type: 'waitNode', position: { x: 300, y: 320 }, data: { stepType: 'wait', label: 'Wait 3 days', duration: 3, durationUnit: 'days' } },
      { id: 'condition-1', type: 'conditionNode', position: { x: 300, y: 460 }, data: { stepType: 'condition', label: 'Payment resolved?', conditionField: 'link_clicked', conditionOp: 'equals', conditionValue: 'true' } },
      { id: 'tag-1', type: 'tagNode', position: { x: 100, y: 640 }, data: { stepType: 'tag', label: 'Tag: payment-recovered', tagName: 'payment-recovered', tagAction: 'add' } },
      { id: 'email-2', type: 'emailNode', position: { x: 500, y: 640 }, data: { stepType: 'email', label: 'Final notice', subject: 'Final notice: Your membership may lapse', body: 'Hi {{first_name}}, this is our final reminder. Update your payment method to avoid losing your membership benefits.' } },
      { id: 'wait-2', type: 'waitNode', position: { x: 500, y: 780 }, data: { stepType: 'wait', label: 'Wait 4 days', duration: 4, durationUnit: 'days' } },
      { id: 'sms-1', type: 'smsNode', position: { x: 500, y: 920 }, data: { stepType: 'sms', label: 'SMS last chance', body: 'Hi {{first_name}}, your membership is at risk. Update your payment: link.example.com/update' } },
    ],
    edges: [
      { id: 'e1', source: 'trigger-1', target: 'email-1', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e2', source: 'email-1', target: 'wait-1', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e3', source: 'wait-1', target: 'condition-1', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e4', source: 'condition-1', sourceHandle: 'yes', target: 'tag-1', animated: true, style: { stroke: '#10b981', strokeWidth: 2 }, label: 'Yes', labelStyle: { fontWeight: 700, fontSize: 11, fill: '#10b981' }, markerEnd: { type: MarkerType.ArrowClosed, color: '#10b981' } },
      { id: 'e5', source: 'condition-1', sourceHandle: 'no', target: 'email-2', animated: true, style: { stroke: '#f97316', strokeWidth: 2 }, label: 'No', labelStyle: { fontWeight: 700, fontSize: 11, fill: '#f97316' }, markerEnd: { type: MarkerType.ArrowClosed, color: '#f97316' } },
      { id: 'e6', source: 'email-2', target: 'wait-2', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
      { id: 'e7', source: 'wait-2', target: 'sms-1', animated: true, style: { stroke: '#6366f1', strokeWidth: 2 }, markerEnd: { type: MarkerType.ArrowClosed, color: '#6366f1' } },
    ],
  },
}
    ...
    <div className={cn(
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0">
          ...
          <p className="text-sm font-semibold truncate">{data.duration} {data.durationUnit}</p>
        </div>
      </div>
    </div>
  )
...
export default function EditAutomationPage() {
  ...
  const automationData = AUTOMATION_DB[id]

  // Fallback for unknown IDs
  const fallbackMeta: AutomationMeta = { name: `Automation ${id}`, triggerType: 'signup', active: false, enrolled: 0, completed: 0, conversionRate: 0 }
  const meta = automationData?.meta ?? fallbackMeta
  const initialNodes = automationData?.nodes ?? []
  const initialEdges = automationData?.edges ?? []

  const [flowName, setFlowName] = useState(meta.name)
  const [isActive, setIsActive] = useState(meta.active)
  const [triggerType, setTriggerType] = useState<TriggerType>(meta.triggerType)
        ...
        <div className="flex items-center gap-3">
          ...
          {isActive ? (
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-amber-50 text-amber-700 text-sm font-semibold hover:bg-amber-100 transition-colors border border-amber-200"
            >
