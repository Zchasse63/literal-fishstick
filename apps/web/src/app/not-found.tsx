  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#0F0F11] flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-[64px] font-black text-gray-900 dark:text-gray-100 leading-none mb-2">404</h1>
        <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Page not found</h2>
