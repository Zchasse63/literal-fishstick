...
export default function UnsubscribePage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#0F0F11] flex items-center justify-center p-6">
      <motion.div
        {...fadeInUp}
        className="w-full max-w-md bg-white dark:bg-gray-950 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm p-8"
      >
        {state === 'confirm' && (
          <div className="text-center">
            ...
            <h1 className="text-xl font-black text-gray-900 dark:text-gray-100 tracking-tight">Unsubscribe</h1>
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              <a
                href="/"
                className="inline-flex items-center justify-center gap-1.5 px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-800 text-sm font-semibold text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
              >
        ...
        {state === 'processing' && (
          <div className="text-center py-4">
            ...
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Processing your request...</p>
          </div>
        )}
        ...
        {state === 'success' && (
          <div className="text-center">
            ...
            <h1 className="text-xl font-black text-gray-900 dark:text-gray-100 tracking-tight">You&apos;re Unsubscribed</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 leading-relaxed">
        ...
        {state === 'invalid' && (
          <div className="text-center">
            ...
            <h1 className="text-xl font-black text-gray-900 dark:text-gray-100 tracking-tight">Invalid Link</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 leading-relaxed">
              {errorMsg}
            </p>
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-4">
        ...
        {state === 'error' && (
          <div className="text-center">
            ...
            <h1 className="text-xl font-black text-gray-900 dark:text-gray-100 tracking-tight">Something Went Wrong</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 leading-relaxed">
              {errorMsg}
            </p>
            <button
              onClick={() => setState('confirm')}
              className="mt-4 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-800 text-sm font-semibold text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
            >
              Try Again
            </button>
          </div>
